...
// GetPostgres function    returns a new Postgres with
// if have not been initialized or returns an initialized
// Postgres instance. We use a singleton method and a single
// database.
